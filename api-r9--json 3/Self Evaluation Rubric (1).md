...
The skills this project focused on were: Finding an API and using the data from the API to create an app. Designing and app first by sketching and then actually turning it into an app using Expo.Learning how to display the data from the API.
